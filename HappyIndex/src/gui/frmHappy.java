...
public class frmHappy extends JFrame {
    ...
    private void initComponents() {
        ...
        /* 128 */ this.jLabel3.setText("Happy Index Report!!!");

        /* 130 */ GroupLayout layout = new GroupLayout(getContentPane());
        /* 131 */ getContentPane().setLayout(layout);
        /* 132 */ layout.setHorizontalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(layout.createSequentialGroup().addContainerGap().addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(layout.createSequentialGroup().addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING, false).addComponent(this.btnDoc1, -1, 208, 32767)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(layout.createParallelGroup(GroupLayout.Alignment.TRAILING).addComponent(this.txtRuta1, -1, 186, 32767)).addContainerGap()).addGroup(GroupLayout.Alignment.TRAILING, layout.createSequentialGroup().addComponent(this.jLabel1, -1, 98, 32767).addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED).addGroup(layout.createParallelGroup(GroupLayout.Alignment.TRAILING).addComponent(this.jSeparator2, -2, 302, -2).addGroup(layout.createSequentialGroup().addComponent(this.jLabel3).addContainerGap()))))).addComponent(this.jSeparator1, GroupLayout.Alignment.TRAILING, -1, 420, 32767).addGroup(layout.createSequentialGroup().addContainerGap().addComponent(this.btnGenerar, -1, 400, 32767).addContainerGap()).addGroup(GroupLayout.Alignment.TRAILING, layout.createSequentialGroup().addContainerGap(359, 32767).addComponent(this.jLabel2).addContainerGap()));

        /* 164 */ layout.setVerticalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(GroupLayout.Alignment.TRAILING, layout.createSequentialGroup().addContainerGap(-1, 32767).addGroup(layout.createParallelGroup(GroupLayout.Alignment.TRAILING).addComponent(this.jLabel1).addGroup(layout.createSequentialGroup().addComponent(this.jLabel3).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.jSeparator2, -2, 10, -2))).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(layout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(this.btnDoc1, -2, 38, -2).addComponent(this.txtRuta1, -2, 33, -2)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(layout.createParallelGroup(GroupLayout.Alignment.BASELINE)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.jSeparator1, -2, 10, -2).addGap(1, 1, 1).addComponent(this.btnGenerar, -2, 38, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.jLabel2).addGap(5, 5, 5)));
    ...
    private void btnGenerarActionPerformed(ActionEvent evt) {
        try {
            ...
            /* 236 */ File f = xls.processDocuments(this.file1.getCanonicalPath(), "resultado_consolidado_index.xls");
            /* 237 */ cleanAll();
